...
/** AppPAL can-say statement can-say D Fact */
public class CanSay extends VP implements EntityHolding {
  ...
  public String toString() {
    if (this.d == D.INF) return "can-say " + this.d + " " + this.fact;
    else return "can-say " + this.fact;
  }
