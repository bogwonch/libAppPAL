...
public class Variable extends E {
  ...
  public String toString() {
    ...
    if (this.type == null || this.typeObliged) out.append(name);
    else {
  ...
  public static Variable parse(String str) throws IOException {
    E e = E.parse(str);
    if (e instanceof Variable) return (Variable) e;
    else throw new IOException("parsed something else when parsing a variable");
  }
  ...
  public static Variable getFresh() {
    return new Variable("_" + fresh++);
  }
}
